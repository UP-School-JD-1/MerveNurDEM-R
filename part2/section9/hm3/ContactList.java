...
public class ContactList {
	...
	public void addContact() throws IOException {
		...
		System.out.println("Please enter Specify the contact type (1) Personalor (2) Business: ");
		...
		if (contactType == 1) {
			...
			entry = new PersonalContact(firstName, lastName, address, email, phone, dateOfBirth);
			...
			entry = new BusinessContact(firstName, lastName, address, email, phone, jobTitle, organization);
			contactlist.add(entry);
			top++;
			try {
				entry.write();
