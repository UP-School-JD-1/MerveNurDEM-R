...
public class Test {
	...
	public static void main(String[] args) {
		...
		// Head of Software Engineering department is James Ford and consequently his
		// department is Software Engineering.
		department1.head = professor1;
		professor1.department = department1;

		// Department of Int. to Software Engineering course is Software Engineering and
		...
		System.out.println(
				"Name of student student1's first course's professor is " + student1.coursesTaken[0].teacher.name);
